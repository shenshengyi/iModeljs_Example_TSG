...
class OpenIModelButton extends React.PureComponent<
  OpenIModelButtonProps,
  OpenIModelButtonState
> {
  public state = { isLoading: false };

  /** Finds project and imodel ids using their names */
  private async getIModelInfo(): Promise<{
    projectId: string;
    imodelId: string;
  }> {
      ...
      <div>
        <div>
          <Button
            ...
            className="button-open-imodel"
            onClick={this._onClickOpen}
          >
            <span>
              {IModelApp.i18n.translate(
                "NineZoneSample:components.imodel-picker.open-imodel"
              )}
            </span>
        ...
        <div>
          ...
          >
            <span>
              {IModelApp.i18n.translate(
                "NineZoneSample:components.imodel-picker.signout"
              )}
            </span>
          </Button>
        </div>
