...
const loggerCategory: string = "LocalhostHandler";
 ...
 * Note: this class should be consumed from @bentley/itwin-backend-client package starting with 2.2 version.
 * @internal
 */
export class LocalhostHandler implements FileHandler {
  public agent: https.Agent = new https.Agent({ keepAlive: true, keepAliveMsecs: 30000, secureProtocol: "TLSv1_2_method" });
